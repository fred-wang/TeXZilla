...
var tests = [
    ...
    /* mathvariant */
    ["\\mathbb{x} \\mathbf{x} \\mathit{x} \\mathscr{x} \\mathcal{x}  \\mathscr{x} \\mathbscr{x} \\mathsf{x} \\mathfrak{x} \\mathit{x} \\mathtt{x} \\mathrm{x}", '<math xmlns="http://www.w3.org/1998/Math/MathML"><semantics><mrow><mi mathvariant="double-struck">x</mi><mi mathvariant="bold">x</mi><mi mathvariant="italic">x</mi><mi mathvariant="script">x</mi><mi mathvariant="script">x</mi><mi mathvariant="script">x</mi><mi mathvariant="bold-script">x</mi><mi mathvariant="sans-serif">x</mi><mi mathvariant="fraktur">x</mi><mi mathvariant="italic">x</mi><mi mathvariant="monospace">x</mi><mi mathvariant="normal">x</mi></mrow><annotation encoding="TeX">\\mathbb{x} \\mathbf{x} \\mathit{x} \\mathscr{x} \\mathcal{x}  \\mathscr{x} \\mathbscr{x} \\mathsf{x} \\mathfrak{x} \\mathit{x} \\mathtt{x} \\mathrm{x}</annotation></semantics></math>'],
